  ...
  final List<Map<String, dynamic>> kingsData = [
    {
      ...
      "desc":
          "بزوغ فجر الدولة السعودية الأولى من الدرعية، حيث وضع الركائز الأساسية لوحدة الكيان.",
    ...
    },
    {
      ...
      "desc":
          "إعادة بناء الكيان واتخاذ الرياض عاصمة للدولة السعودية الثانية بعد رحلة كفاح.",
    ...
    },
    {
      ...
      "desc":
          "المؤسس الذي وحد الشتات وأعلن قيام المملكة العربية السعودية الحديثة.",
    ...
    },
    {
      ...
      "desc":
          "أول من أسس الوزارات وطور التعليم والخدمات الصحية، وشهد عهده أولى توسعات الحرمين.",
    ...
    },
    {
      ...
      "desc":
          "رائد النهضة الإدارية والاقتصادية، وعُرف بمواقفه العربية والإسلامية العظيمة دولياً.",
    ...
    },
    {
      ...
      "desc":
          "تميز عهده بالرخاء الاقتصادي والمشاريع التنموية الضخمة في كافة أنحاء المملكة.",
    ...
    },
    {
      ...
      "desc":
          "خادم الحرمين الشريفين، شهد عهده تحديثاً شاملاً للأنظمة وتوسعة تاريخية للحرمين.",
    ...
    },
    {
      ...
      "desc":
          "عُرف بملك الإنسانية، ركز على تطوير التعليم العالي وبرامج الابتعاث والمدن الاقتصادية.",
    ...
    },
    {
      ...
      "desc":
          "قيادة مرحلة التحول التاريخي ورؤية ٢٠٣٠ لتمكين الإنسان وبناء المستقبل.",
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _buildHeader(),
            ...kingsData.asMap().entries.map((entry) {
              final index = entry.key;
              final king = entry.value;
...
// باقي كود _AnimatedTimelineItem زي ما عندك تمام
                ...
                Expanded(
                  child: isLeft
                      ...
                      : ScaleTransition(
                          ...
                          child: _buildKingImage(widget.king["image"]),
                        ),
                ),
                Container(
                  width: 30,
